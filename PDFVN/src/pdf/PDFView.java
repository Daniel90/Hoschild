...
import consulta.sqlVendedor;
import consulta.sqlVendedor2;
import consulta.sqlVendedorAnterior;
import consulta.sqlVendedor2Anterior;
...
public class PDFView extends FrameView {
   ...
   public static PdfPTable createTableEneroV(int mes,ResultSet documentosPower7) throws DocumentException, SQLException{
        ...
        PdfPCell cellTitulo = new PdfPCell(new Paragraph("VENTA POR FAMILIA AÑO 2014 - NACIONAL",FontFactory.getFont(FontFactory.TIMES_BOLD,10)));
   ...
   public static PdfPTable PDFTableGeneric(int anteriorMes,int mes,int Ano,int fechaInicialPower,int fechaFinalPower, ResultSet consulta,String mesS, String mesAnt, ResultSet consultaAnterior)throws DocumentException, SQLException{
        ...
        tabla.setWidths(new float[]{0.04f,0.1f,0.1f,0.1f,0.1f,0.1f,0.1f,0.1f});
        PdfPCell cellTitulo = new PdfPCell(new Paragraph("VENTA POR FAMILIA AÑO "+Ano+" - NACIONAL",FontFactory.getFont(FontFactory.TIMES_BOLD,10)));
        cellTitulo.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTitulo.setBackgroundColor(BaseColor.LIGHT_GRAY);
        cellTitulo.setColspan(8);
        tabla.addCell(cellTitulo);
        ...
        PdfPCell cellFAM = new PdfPCell(new Paragraph("Familia",fuente));
        cellFAM.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellFAM.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellFAM);
        ...
        PdfPCell cellVENEROAn = new PdfPCell(new Paragraph("Total Kilos de "+mesAnt,fuente));
        cellVENEROAn.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellVENEROAn.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellVENEROAn);

        PdfPCell cellVENERO = new PdfPCell(new Paragraph("Total Kilos de "+mesS,fuente));
        cellVENERO.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellVENERO.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellVENERO);
        
        PdfPCell cellTotAnt = new PdfPCell(new Paragraph("Total ventas de "+mesAnt,fuente));
        cellTotAnt.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTotAnt.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellTotAnt);
        
        PdfPCell cellTot = new PdfPCell(new Paragraph("Total ventas de "+mesS,fuente));
        cellTot.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTot.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellTot);
        
        PdfPCell cellTot1Ant = new PdfPCell(new Paragraph("Precio por kilo de "+mesAnt,fuente));
        cellTot1Ant.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTot1Ant.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellTot1Ant);
        
        PdfPCell cellTot1 = new PdfPCell(new Paragraph("Precio por kilo de "+mesS,fuente));
        cellTot1.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTot1.setBackgroundColor(BaseColor.LIGHT_GRAY);
        tabla.addCell(cellTot1);
               
        while(consulta.next() && consultaAnterior.next()){
                String familia = consulta.getString("FAMF57");
                System.out.println(familia);
                System.out.println(" ");
                PdfPCell celdaFAM = new PdfPCell(new Phrase(familia,fuente));
                celdaFAM.setHorizontalAlignment(Element.ALIGN_CENTER);
                celdaFAM.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaFAM);

                PdfPCell celdaDES = new PdfPCell(new Phrase(consulta.getString("DESF57"),fuente));
                celdaDES.setHorizontalAlignment(Element.ALIGN_LEFT);
                celdaDES.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaDES);

                DecimalFormat df = new DecimalFormat("###,###,###.00");
                String cadena = "";
                
                cadena = String.valueOf(df.format(Float.parseFloat(consultaAnterior.getString("KILF57"))));
                PdfPCell celdaKilAnt = new PdfPCell(new Phrase(cadena,fuente));
                celdaKilAnt.setHorizontalAlignment(Element.ALIGN_RIGHT);
                celdaKilAnt.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaKilAnt);
                
                cadena = String.valueOf(df.format(Float.parseFloat(consulta.getString("KILF57"))));
                PdfPCell celdaKil = new PdfPCell(new Phrase(cadena,fuente));
                celdaKil.setHorizontalAlignment(Element.ALIGN_RIGHT);
                celdaKil.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaKil);
                
                cadena = String.valueOf(df.format(Float.parseFloat(consultaAnterior.getString("VTAF57"))));
                PdfPCell celdaVTAAnt = new PdfPCell(new Phrase(cadena,fuente));
                celdaVTAAnt.setHorizontalAlignment(Element.ALIGN_RIGHT);
                celdaVTAAnt.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaVTAAnt);
                
                cadena = String.valueOf(df.format(Float.parseFloat(consulta.getString("VTAF57"))));
                PdfPCell celdaVTA = new PdfPCell(new Phrase(cadena,fuente));
                celdaVTA.setHorizontalAlignment(Element.ALIGN_RIGHT);
                celdaVTA.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaVTA);
                
                cadena = String.valueOf(df.format(Float.parseFloat(consultaAnterior.getString("PREF57"))));
                PdfPCell celdaPREFAnt = new PdfPCell(new Phrase(cadena,fuente));
                celdaPREFAnt.setHorizontalAlignment(Element.ALIGN_RIGHT);
                celdaPREFAnt.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaPREFAnt);
                
                cadena = String.valueOf(df.format(Float.parseFloat(consulta.getString("PREF57"))));
                PdfPCell celdaPREF = new PdfPCell(new Phrase(cadena,fuente));
                celdaPREF.setHorizontalAlignment(Element.ALIGN_RIGHT);
                celdaPREF.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(celdaPREF);
                
                sqlVendedor2 vendedor2 = new sqlVendedor2();
                sqlVendedor2Anterior vendedor2Anterior = new sqlVendedor2Anterior();
                ResultSet consulta2 = vendedor2.consultaVendedor2(fechaInicialPower, fechaFinalPower,mes,Ano);
                ResultSet consulta2Anterior = vendedor2Anterior.consultaVendedor2Anterior(mesAnt,anteriorMes,Ano);
                while(consulta2.next() && consulta2Anterior.next()){
                    
                    String familia2 = consulta2.getString("FAMV57");
                    if(familia2.equals(familia)){                   
                        System.out.println(familia2);
                        PdfPCell celdaCOD = new PdfPCell(new Phrase(consulta2.getString("CVEV57"),cuerpo));
                        celdaCOD.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaCOD);

                        PdfPCell celdaNOM = new PdfPCell(new Phrase(consulta2.getString("NVEN57"),cuerpo));
                        celdaNOM.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaNOM);
                        
                        cadena = String.valueOf(df.format(Float.parseFloat(consulta2Anterior.getString("KILV57"))));
                        PdfPCell celdaTKAnt = new PdfPCell(new Phrase(cadena,cuerpo));
                        celdaTKAnt.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaTKAnt);
                        
                        cadena = String.valueOf(df.format(Float.parseFloat(consulta2.getString("KILV57"))));
                        PdfPCell celdaTK = new PdfPCell(new Phrase(cadena,cuerpo));
                        celdaTK.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaTK);
                        
                        cadena = String.valueOf(df.format(Float.parseFloat(consulta2Anterior.getString("VTAV57"))));
                        PdfPCell celdaVTAVAnt = new PdfPCell(new Phrase(cadena,cuerpo));
                        celdaVTAVAnt.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaVTAVAnt);
                        
                        cadena = String.valueOf(df.format(Float.parseFloat(consulta2.getString("VTAV57"))));
                        PdfPCell celdaVTAV = new PdfPCell(new Phrase(cadena,cuerpo));
                        celdaVTAV.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaVTAV);
                        
                        cadena = String.valueOf(df.format(Float.parseFloat(consulta2Anterior.getString("PREV57"))));
                        PdfPCell celdaPREVAnt = new PdfPCell(new Phrase(cadena,cuerpo));
                        celdaPREVAnt.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaPREVAnt);
                        
                        cadena = String.valueOf(df.format(Float.parseFloat(consulta2.getString("PREV57"))));
                        PdfPCell celdaPREV = new PdfPCell(new Phrase(cadena,cuerpo));
                        celdaPREV.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        tabla.addCell(celdaPREV);
                    }
                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(Ano > anoActual)
                ...
                sqlVendedorAnterior vendedorAnterior = new sqlVendedorAnterior();
                Document documento = new Document(PageSize.LETTER.rotate());
                
               
                documento.setMargins(-50, -50, 55, 50);
                ResultSet consulta = vendedor.consultaVendedor(fechaInicialPower, fechaFinalPower,mes,Ano);                          
                ResultSet consultaAnt = vendedorAnterior.consultaVendedorAnterior(mesAnt,AnteriorMes, Ano);
                ...
                try{
                    documento.open();
                    PdfPTable tabla = PDFTableGeneric(AnteriorMes,mes,Ano,fechaInicialPower, fechaFinalPower, consulta, mesS, mesAnt,consultaAnt);
                    documento.add(tabla);    
                    documento.close();
