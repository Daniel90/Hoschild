    ...
    public ResultSet documentosKilos(int fechaInicial, int fechaFinal,int mes,int ano){
        ...
        try{
            ...
            try{
                ...
                switch(mes){
                    case 01:
                        String sql_clmhp403 = "select famn87,desn87,k01n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                    case 02:
                        String sql_clmhp404 = "select famn87,desn87,k01n87,k02n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 03:
                        String sql_clmhp405 = "select famn87,desn87,k01n87,k02n87,k03n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 04:
                        String sql_clmhp406 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 05:
                        String sql_clmhp407 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 06:
                        String sql_clmhp408 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 07:
                        String sql_clmhp409 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87,k07n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 8:
                        String sql_clmhp410 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87,k07n87,k08n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 9:
                        String sql_clmhp411 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87,k07n87,k08n87,k09n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 10:
                        String sql_clmhp412 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87,k07n87,k08n87,k09n87,k10n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 11:
                        String sql_clmhp413 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87,k07n87,k08n87,k09n87,k10n87,k11n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
                        ...
                        break;
                     case 12:
                        String sql_clmhp414 = "select famn87,desn87,k01n87,k02n87,k03n87,k04n87,k05n87,k06n87,k07n87,k08n87,k09n87,k10n87,k11n87,k12n87 from " + database_clmhp403 + " where paan87 = "+ano+"";
