...
public class PDFView extends FrameView {
    ...
    private void initComponents() {
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .addGroup(statusPanelLayout.createSequentialGroup()
                .addComponent(statusPanelSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE)
                .addGap(220, 220, 220))
            .addGroup(statusPanelLayout.createSequentialGroup()
                .addContainerGap()
   ...
   public static PdfPTable createTableEneroD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7,int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        PdfPCell cellTitulo = new PdfPCell(new Paragraph("PRECIOS POR KILOS AÑO "+ano+" - NACIONAL",FontFactory.getFont(FontFactory.TIMES_BOLD,10)));
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
                ...
                float dividendo = Float.parseFloat(documentosPower7.getString("V01N87"));
                float divisor = Float.parseFloat(documentosKilos7.getString("K01N87"));
   ...
   public static PdfPTable createTableFD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
       Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
                ...
                String cadenaEne = "";
                sumaEnero = sumaEnero + Float.parseFloat(documentosPower7.getString("V01N87"));
                float dividendoE = Float.parseFloat(documentosPower7.getString("V01N87"));
                float divisorE = Float.parseFloat(documentosKilos7.getString("K01N87"));
                ...
                float dividendoF = Float.parseFloat(documentosPower7.getString("V02N87"));
                float divisorF = Float.parseFloat(documentosKilos7.getString("K02N87"));
   ...
   public static PdfPTable createTableMD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        float sumaHorizontal = 0,sumaEnero = 0,sumaFeb = 0,sumaMar = 0,sumT = 0;
         while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoM = Float.parseFloat(documentosPower7.getString("V03N87"));
            float divisorM = Float.parseFloat(documentosKilos7.getString("K03N87"));
   ...
   public static PdfPTable createTableAD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7,int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoA = Float.parseFloat(documentosPower7.getString("V04N87"));
            float divisorA = Float.parseFloat(documentosKilos7.getString("K04N87"));
   ...
   public static PdfPTable createTableMayD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoMAY = Float.parseFloat(documentosPower7.getString("V05N87"));
            float divisorMAY = Float.parseFloat(documentosKilos7.getString("K05N87"));
   ...
   public static PdfPTable createTableJD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
       Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoJ = Float.parseFloat(documentosPower7.getString("V06N87"));
            float divisorJ = Float.parseFloat(documentosKilos7.getString("K06N87"));
   ...
   public static PdfPTable createTableJulD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
       Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoJul = Float.parseFloat(documentosPower7.getString("V07N87"));
            float divisorJul = Float.parseFloat(documentosKilos7.getString("K07N87"));
   ...
   public static PdfPTable createTableAgoD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(8);
        cuerpo.setSize(7);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoAgos = Float.parseFloat(documentosPower7.getString("V08N87"));
            float divisorAgos = Float.parseFloat(documentosKilos7.getString("K08N87"));
   ...
   public static PdfPTable createTableSD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
      Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(7);
        cuerpo.setSize(6);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoS = Float.parseFloat(documentosPower7.getString("V09N87"));
            float divisorS = Float.parseFloat(documentosKilos7.getString("K09N87"));
   ...
   public static PdfPTable createTableOD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
       Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(7);
        cuerpo.setSize(6);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoO = Float.parseFloat(documentosPower7.getString("V10N87"));
            float divisorO = Float.parseFloat(documentosKilos7.getString("K10N87"));
   ...
   public static PdfPTable createTableND(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
      Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(6);
        cuerpo.setSize(5);
        ...
        while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoN = Float.parseFloat(documentosPower7.getString("V11N87"));
            float divisorN = Float.parseFloat(documentosKilos7.getString("K11N87"));
   ...
   public static PdfPTable createTableDD(int mes, ResultSet documentosPower7, ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
       Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(6);
        cuerpo.setSize(5);
        ...
        float sumaHorizontal = 0,sumaEnero = 0,sumaFeb = 0,sumaMar = 0,sumaAbr = 0,sumaMay = 0,sumaJun = 0,sumaJul = 0,sumaAgos = 0,sumaSep = 0,sumaOct = 0,sumaNov = 0,sumaDic = 0,sumT = 0;
         ...
         while(documentosPower7.next() && documentosKilos7.next()){
            ...
            float dividendoD = Float.parseFloat(documentosPower7.getString("V12N87"));
            float divisorD = Float.parseFloat(documentosKilos7.getString("K12N87"));
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public static PdfPTable createTableEneroV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        PdfPTable tabla = new PdfPTable(4);
        tabla.setWidths(new float[]{0.01f,0.1f,0.1f,0.1f});
        PdfPCell cellTitulo = new PdfPCell(new Paragraph("VENTAS EN PESOS AÑO "+ano+" - NACIONAL",FontFactory.getFont(FontFactory.TIMES_BOLD,10)));
        cellTitulo.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTitulo.setBackgroundColor(BaseColor.LIGHT_GRAY);
        cellTitulo.setColspan(4);
        tabla.addCell(cellTitulo);
   ...
   public static PdfPTable createTableEFV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        PdfPCell cellTitulo = new PdfPCell(new Paragraph("VENTA EN PESOS AÑO "+ano+" - NACIONAL",FontFactory.getFont(FontFactory.TIMES_BOLD,10)));
        cellTitulo.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTitulo.setBackgroundColor(BaseColor.LIGHT_GRAY);
        cellTitulo.setColspan(5);
        tabla.addCell(cellTitulo);
   ...
   public static PdfPTable createTableEFMV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMJV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMJJV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMJJAV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(8);
        cuerpo.setSize(7);
   ...
   public static PdfPTable createTableEFMAMJJASV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(7);
        cuerpo.setSize(6);
   ...
   public static PdfPTable createTableEFMAMJJASOV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(7);
        cuerpo.setSize(6);
   ...
   public static PdfPTable createTableEFMAMJJASONV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(6);
        cuerpo.setSize(5);
   ...
   public static PdfPTable createTableEFMAMJJASONDV(int mes,ResultSet documentosPower7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(6);
        cuerpo.setSize(5);
   ...
   public static PdfPTable createTableEneroK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
        ...
        PdfPTable tabla = new PdfPTable(4);
        tabla.setWidths(new float[]{0.01f,0.1f,0.1f,0.1f});
        PdfPCell cellTitulo = new PdfPCell(new Paragraph("KILOS AÑO "+ano+" - NACIONAL",FontFactory.getFont(FontFactory.TIMES_BOLD,10)));
        cellTitulo.setHorizontalAlignment(Element.ALIGN_CENTER);
        cellTitulo.setBackgroundColor(BaseColor.LIGHT_GRAY);
        cellTitulo.setColspan(4);
        tabla.addCell(cellTitulo);
   ...
   public static PdfPTable createTableEFK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMJK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMJJK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(9);
        cuerpo.setSize(8);
   ...
   public static PdfPTable createTableEFMAMJJAK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(8);
        cuerpo.setSize(7);
   ...
   public static PdfPTable createTableEFMAMJJASK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(7);
        cuerpo.setSize(6);
   ...
   public static PdfPTable createTableEFMAMJJASOK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(7);
        cuerpo.setSize(6);
   ...
   public static PdfPTable createTableEFMAMJJASONK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(6);
        cuerpo.setSize(5);
   ...
   public static PdfPTable createTableEFMAMJJASONDK(int mes,ResultSet documentosKilos7, int ano) throws DocumentException, SQLException{
        Font fuente= new Font();
        Font cuerpo = new Font();
        fuente.setSize(6);
        cuerpo.setSize(5);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(Ano > anoActual)
                ...
                ResultSet documentosPower72 = consultaPower2.documentosPower(fechaInicialPower, fechaFinalPower, mes, Ano);
                ResultSet documentosKilos = consultaKilos.documentosKilos(fechaInicialPower, fechaFinalPower, mes, Ano);
                ResultSet documentosKilos2 = consultaKilos2.documentosKilos(fechaInicialPower, fechaFinalPower, mes, Ano);
                ...
                try{
                     if(mes == 01){
                            //tabla para enero de ventas
                            documento.open();
                            PdfPTable tabla = createTableEneroV(mes,documentosPower7,anoTec);
                            documento.add(tabla);
                            //tabla para enero de kilos
                            tabla = createTableEneroK(mes,documentosKilos,anoTec);                           
                            tabla.setSpacingBefore(30);
                            tabla.setSpacingAfter(30);  
                            documento.add(tabla);
                            //tabla que muestra logo y fecha actual
                            tabla = createMiniTable(diaA, mesA, anoA);
                            tabla.setSpacingBefore(30);
                            tabla.setSpacingAfter(30);
                            documento.add(tabla);
                            //tabla que clacula precios por kilo
                            tabla = createTableEneroD(mes, documentosPower72,documentosKilos2,anoTec);
                         ...
                         if(mes == 02){
                            documento.open();
                            PdfPTable tabla = createTableEFV(mes,documentosPower7,anoTec);
                            documento.add(tabla);
                            tabla = createTableEFK(mes,documentosKilos,anoTec);                           
                            tabla.setSpacingBefore(30);
                            tabla.setSpacingAfter(30);  
                            documento.add(tabla);
                            tabla = createMiniTable(diaA, mesA, anoA);
                            ...
                            tabla.setSpacingAfter(30);
                            documento.add(tabla);
                            tabla = createTableFD(mes, documentosPower72,documentosKilos2,anoTec);
                            tabla.setSpacingBefore(50);
                            tabla.setSpacingAfter(50);
                            documento.add(tabla);
                            ...
                            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                             ...
                             if(mes == 03){
                                documento.open();
                                PdfPTable tabla = createTableEFMV(mes,documentosPower7,anoTec);
                                documento.add(tabla);
                                tabla = createTableEFMK(mes,documentosKilos,anoTec);                           
                                tabla.setSpacingBefore(30);
                                tabla.setSpacingAfter(30);  
                                documento.add(tabla);
                                tabla = createMiniTable(diaA, mesA, anoA);
                                ...
                                tabla.setSpacingAfter(30);
                                documento.add(tabla);
                                tabla = createTableMD(mes, documentosPower72,documentosKilos2,anoTec);
                                tabla.setSpacingBefore(50);
                                tabla.setSpacingAfter(50);
                                documento.add(tabla);
                                documento.close();
                                ...
                                Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                 ...
                                 if(mes == 04){
                                    documento.open();
                                    PdfPTable tabla = createTableEFMAV(mes,documentosPower7,anoTec);
                                    documento.add(tabla);
                                    tabla = createTableEFMAK(mes,documentosKilos,anoTec);                           
                                    tabla.setSpacingBefore(30);
                                    tabla.setSpacingAfter(30);  
                                    documento.add(tabla);
                                    tabla = createMiniTable(diaA, mesA, anoA);
                                    ...
                                    tabla.setSpacingAfter(30);
                                    documento.add(tabla);
                                    tabla = createTableAD(mes, documentosPower72,documentosKilos2,anoTec);
                                    tabla.setSpacingBefore(50);
                                    tabla.setSpacingAfter(50);
                                    documento.add(tabla);
                                    documento.close();
                                    ...
                                    Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                     ...
                                     if(mes == 05){
                                        documento.open();
                                        PdfPTable tabla = createTableEFMAMV(mes,documentosPower7,anoTec);
                                        documento.add(tabla);
                                        tabla = createTableEFMAMK(mes,documentosKilos,anoTec);                           
                                        tabla.setSpacingBefore(30);
                                        tabla.setSpacingAfter(30);  
                                        documento.add(tabla);
                                        tabla = createMiniTable(diaA, mesA, anoA);
                                        ...
                                        tabla.setSpacingAfter(30);
                                        documento.add(tabla);
                                        tabla = createTableMayD(mes, documentosPower72,documentosKilos2,anoTec);
                                        tabla.setSpacingBefore(50);
                                        tabla.setSpacingAfter(50);
                                        documento.add(tabla);
                                        documento.close();
                                        ...
                                        Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                         ...
                                         if(mes == 06){
                                            documento.open();
                                            PdfPTable tabla = createTableEFMAMJV(mes,documentosPower7,anoTec);
                                            documento.add(tabla);
                                            tabla = createTableEFMAMJK(mes,documentosKilos,anoTec);                           
                                            tabla.setSpacingBefore(30);
                                            tabla.setSpacingAfter(30);  
                                            documento.add(tabla);
                                            tabla = createMiniTable(diaA, mesA, anoA);
                                            ...
                                            tabla.setSpacingAfter(30);
                                            documento.add(tabla);
                                            tabla = createTableJD(mes, documentosPower72,documentosKilos2,anoTec);
                                            tabla.setSpacingBefore(50);
                                            tabla.setSpacingAfter(50);
                                            documento.add(tabla);
                                            documento.close();
                                            ...
                                            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                             ...
                                             if(mes == 07){
                                                documento.open();
                                                PdfPTable tabla = createTableEFMAMJJV(mes,documentosPower7,anoTec);
                                                documento.add(tabla);
                                                tabla = createTableEFMAMJJK(mes,documentosKilos,anoTec);                           
                                                tabla.setSpacingBefore(30);
                                                tabla.setSpacingAfter(30);  
                                                documento.add(tabla);
                                                tabla = createMiniTable(diaA, mesA, anoA);
                                                ...
                                                tabla.setSpacingAfter(30);
                                                documento.add(tabla);
                                                tabla = createTableJulD(mes, documentosPower72,documentosKilos2,anoTec);
                                                tabla.setSpacingBefore(50);
                                                tabla.setSpacingAfter(50);
                                                documento.add(tabla);
                                                documento.close();
                                                ...
                                                Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                                 ...
                                                 if(mes == 8){
                                                    documento.open();
                                                    PdfPTable tabla = createTableEFMAMJJAV(mes,documentosPower7,anoTec);
                                                    documento.add(tabla);
                                                    tabla = createTableEFMAMJJAK(mes,documentosKilos,anoTec);                           
                                                    tabla.setSpacingBefore(30);
                                                    tabla.setSpacingAfter(30);  
                                                    documento.add(tabla);
                                                    tabla = createMiniTable(diaA, mesA, anoA);
                                                    ...
                                                    tabla.setSpacingAfter(30);
                                                    documento.add(tabla);
                                                    tabla = createTableAgoD(mes, documentosPower72,documentosKilos2,anoTec);
                                                    tabla.setSpacingBefore(50);
                                                    tabla.setSpacingAfter(50);
                                                    documento.add(tabla);
                                                    documento.close();
                                                    ...
                                                    Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                                     ...
                                                     if(mes == 9){
                                                        documento.open();
                                                        PdfPTable tabla = createTableEFMAMJJASV(mes,documentosPower7,anoTec);
                                                        documento.add(tabla);
                                                        tabla = createTableEFMAMJJASK(mes,documentosKilos,anoTec);                           
                                                        tabla.setSpacingBefore(30);
                                                        tabla.setSpacingAfter(30);  
                                                        documento.add(tabla);
                                                        tabla = createMiniTable(diaA, mesA, anoA);
                                                        ...
                                                        tabla.setSpacingAfter(50);
                                                        documento.add(tabla);
                                                        tabla = createTableSD(mes, documentosPower72,documentosKilos2,anoTec);
                                                        tabla.setSpacingBefore(50);
                                                        tabla.setSpacingAfter(50);
                                                        documento.add(tabla);
                                                        documento.close();
                                                        ...
                                                        Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                                         ...
                                                         if(mes == 10){
                                                            ...
                                                            documento.open();
                                                            PdfPTable tabla = createTableEFMAMJJASOV(mes,documentosPower7,anoTec);
                                                            documento.add(tabla);
                                                            tabla = createTableEFMAMJJASOK(mes,documentosKilos,anoTec);                           
                                                            tabla.setSpacingBefore(30);
                                                            tabla.setSpacingAfter(30);  
                                                            documento.add(tabla);
                                                            tabla = createMiniTable(diaA, mesA, anoA);
                                                            ...
                                                            tabla.setSpacingAfter(50);
                                                            documento.add(tabla);
                                                            tabla = createTableOD(mes, documentosPower72,documentosKilos2,anoTec);
                                                            tabla.setSpacingBefore(50);
                                                            tabla.setSpacingAfter(50);
                                                            documento.add(tabla);
                                                            documento.close();
                                                            ...
                                                            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                                             ...
                                                             if(mes == 11){
                                                                ...
                                                                documento.open();
                                                                PdfPTable tabla = createTableEFMAMJJASONV(mes,documentosPower7,anoTec);
                                                                documento.add(tabla);
                                                                tabla = createTableEFMAMJJASONK(mes,documentosKilos,anoTec);                           
                                                                ...
                                                                documento.add(tabla);
                                                                tabla = createTableND(mes, documentosPower72,documentosKilos2,anoTec);
                                                                tabla.setSpacingBefore(50);
                                                                tabla.setSpacingAfter(50);
                                                                documento.add(tabla);
                                                                documento.close();
                                                                ...
                                                                Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+path);
                                                                 ...
                                                                 if(mes == 12){
                                                                    documento.setMargins(-97, -97, 25, 20); 
                                                                    documento.open();
                                                                    PdfPTable tabla = createTableEFMAMJJASONDV(mes,documentosPower7,anoTec);
                                                                    documento.add(tabla);
                                                                    tabla = createTableEFMAMJJASONDK(mes,documentosKilos,anoTec);                           
                                                                    tabla.setSpacingBefore(40);
                                                                    tabla.setSpacingAfter(40);  
                                                                    documento.add(tabla);
                                                                    tabla = createMiniTable(diaA, mesA, anoA);
                                                                    ...
                                                                    tabla.setSpacingAfter(60);
                                                                    documento.add(tabla);
                                                                    tabla = createTableDD(mes, documentosPower72,documentosKilos2,anoTec);
                                                                    tabla.setSpacingBefore(50);
                                                                    tabla.setSpacingAfter(50);
                                                                    documento.add(tabla);
                                                                    documento.close();
